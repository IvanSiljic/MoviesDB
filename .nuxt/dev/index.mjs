globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/isiljic/Project/MovieDB/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/isiljic/Project/MovieDB/node_modules/std-env/dist/index.mjs';
import { eventHandler, setHeaders, sendRedirect, defineEventHandler, handleCacheHeaders, createEvent, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, lazyEventHandler, toNodeListener, getQuery, createError } from 'file:///Users/isiljic/Project/MovieDB/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/isiljic/Project/MovieDB/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/isiljic/Project/MovieDB/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///Users/isiljic/Project/MovieDB/node_modules/vue/server-renderer/index.mjs';
import { withoutBase, parseURL, withQuery, joinURL } from 'file:///Users/isiljic/Project/MovieDB/node_modules/ufo/dist/index.mjs';
import destr from 'file:///Users/isiljic/Project/MovieDB/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file:///Users/isiljic/Project/MovieDB/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/isiljic/Project/MovieDB/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/isiljic/Project/MovieDB/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/isiljic/Project/MovieDB/node_modules/hookable/dist/index.mjs';
import { hash } from 'file:///Users/isiljic/Project/MovieDB/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file:///Users/isiljic/Project/MovieDB/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/isiljic/Project/MovieDB/node_modules/unstorage/drivers/fs.mjs';
import defu from 'file:///Users/isiljic/Project/MovieDB/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/isiljic/Project/MovieDB/node_modules/radix3/dist/index.mjs';

const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{},"movieDBKey":"478ced3674cfabd8c121be4250525211"};
...
const serverAssets = [{"baseName":"server","dir":"/Users/isiljic/Project/MovieDB/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/isiljic/Project/MovieDB","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/isiljic/Project/MovieDB/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/isiljic/Project/MovieDB/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/isiljic/Project/MovieDB/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const now_playing = defineEventHandler(async (event) => {
  const { movieDBKey } = useRuntimeConfig();
  const data = await fetch(`https://api.themoviedb.org/3/movie/now_playing?api_key=${movieDBKey}`).then((response) => response.json()).then((data2) => data2);
  return {
    movies: data
  };
});
...
const getClientManifest = () => import('/Users/isiljic/Project/MovieDB/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/isiljic/Project/MovieDB/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<title>The Movie Database</title>\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<link rel=\"stylesheet\" href=\"https://fonts.googleapis.com/css2?family=Material+Symbols+Rounded\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
